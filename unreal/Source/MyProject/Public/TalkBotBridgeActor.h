...
public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "TalkBot|Realtime")
    ETalkBotLipsyncMood RealtimeMood = ETalkBotLipsyncMood::AutoDetect;
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "TalkBot|Realtime", meta = (ClampMin = "0.0", ClampMax = "1.0"))
    float RealtimeAudioIntensityBoost = 0.3f;
...
private:
    ...
    FString RealtimeTranscriptAccumulator;
    float RealtimeSpeechEnergy;
    float RealtimeSpeechEnergyTarget;
    ETalkBotLipsyncMood AppliedRealtimeMood;
    float AppliedRealtimeMoodIntensity;
    ...
    void UpdateRealtimeSpeechEnergyFromPcm(const TArray<uint8>& DecodedPcm);
    void UpdateRealtimeMoodFromText(const FString& TranscriptDelta, bool bIsFinalText);
    void RefreshRealtimeMoodSettings();
    ETalkBotLipsyncMood ResolveRealtimeMood() const;
    float ResolveRealtimeMoodIntensity() const;
